            ...
            <Wrapper>
                <div className="pt-[10px] flex flex-col justify-between items-center lg:flex-row">
                    <div className="max-w-[230px] text-center mb-[60px] lg:mb-0">
                        <div className="flex justify-center"><img src="/assets/Illustration.svg" alt="img content" /></div>
                    ...
                    <div className="max-w-[230px] text-center mb-[60px] lg:mb-0">
                        <div className="flex justify-center"><img src="/assets/Illustration (1).svg" alt="img content" /></div>
                    ...
                    <div className="max-w-[230px] text-center mb-[65px] lg:mb-0">
                        <div className="flex justify-center "><img src="/assets/Illustration (2).svg" alt="img content" /></div>
                    ...
                    <div className="max-w-[230px] text-center">
                        <div className="flex justify-center"><img src="/assets/Illustration (3).svg" alt="img content" /></div>
